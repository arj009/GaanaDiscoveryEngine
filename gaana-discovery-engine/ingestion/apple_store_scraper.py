...
class AppleStoreScraper(BaseScraper):
    ...
    def fetch_reviews(self, limit: int = 100) -> List[ReviewModel]:
        ...
        # Loop pages 1 to 10, similar to the Node.js scraper, to handle empty pages/caching issues
        for page in range(1, 11):
            url = f"https://itunes.apple.com/in/rss/customerreviews/page={page}/id={self.app_id}/sortby=mostRecent/json"
            try:
                ...
                print(f"Error fetching Apple reviews page {page}: {e}")
